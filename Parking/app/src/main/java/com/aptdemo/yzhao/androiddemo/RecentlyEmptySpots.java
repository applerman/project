 ...
 */
public class RecentlyEmptySpots extends AppCompatActivity
        ...
        OnMapClickListener {
    private String TAG  = "Recently Empty Spots";
    ...
    private ArrayList<NamedLocation> locations_array = new ArrayList<NamedLocation>();
        ...
        httpClient.get(request_url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                try {
                    ...
                    JSONArray parkingDoneTimes = jObject.getJSONArray("parkingDoneTime");
                    for (int i = 0; i < parkingLats.length(); i++) {
                        locations_array.add(new NamedLocation(parkingDoneTimes.getString(i), new LatLng(
                ...
                for (int i = 0; i < locations_array.size(); i++) {
                    mMap.addMarker(new MarkerOptions()
                            .title(locations_array.get(i).name)
                            .position(locations_array.get(i).location));
                }
            }
